''' Tuples & Sets '''
## Tuples contain two items per one entry
...
## there are two entries in this tuple so we set temporary variables to them "day" and "num"

# for day, num in weekdays : 
#     print(f'The day is{day} and the month is number {num}')
'''
